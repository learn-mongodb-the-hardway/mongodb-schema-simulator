...
class ShoppingCart(
    ...
    fun addProduct(userId: Any, quantity: Int, product: Document) {
        log("addProduct") {
            // Execute cart update
    ...
    fun updateProduct(userId: Any, newQuantity: Int, product: Document) {
        log("updateProduct") {
    ...
    fun checkout(userId: Any, name: String, address: String, payment: Document) {
        log("checkout") {
    ...
    fun expireAllCarts(cutOffDate: Date) {
        log("expireAllCarts") {
...
//            throw SchemaSimulatorException("values passed to action must be of type NoReservationShoppingCartValues")
//        }
//
//        val cart = carts.find(Document(mapOf(
